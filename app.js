...
function loadUserState(uid) {
  ...
  setTimeout(() => updatePremiumUpgradeScreen(), 100);
...
function updatePremiumUpgradeScreen() {
  try {
    ...
    if (!upgradeScreen) {
      console.warn('[Premium] Upgrade screen element not found');
      return;
    }
    if (!welcomeScreen) {
      console.warn('[Premium] Welcome screen element not found');
      return;
    }
    ...
    if (isPremium) {
      ...
      // Free user - show upgrade screen, hide welcome
      upgradeScreen.style.display = 'block !important';
      upgradeScreen.style.visibility = 'visible';
      upgradeScreen.style.pointerEvents = 'auto';
      welcomeScreen.style.display = 'none';
      welcomeScreen.style.visibility = 'hidden';
      welcomeScreen.style.pointerEvents = 'none';
      console.log('[Premium] Showing upgrade screen for FREE user');
    }
  } catch(e) {

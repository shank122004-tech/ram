...
(function() {
  ...
  async function saveMockTestResults(examCategory, results) {
    try {
      ...
      const currentTotalXP = (window._userData?.totalXP || 0) + results.xp;
      ...
      try {
        const xpStorageKey = `sscai_u:${user.uid}:totalXP`;
        localStorage.setItem(xpStorageKey, String(currentTotalXP));
        
        // Save individual test to history
  ...
  function showQuestionModal() {
    ...
    content.innerHTML = `
      ...
      <div class="mt-modal-footer" style="padding:16px 24px !important;border-top:1px solid rgba(108,99,255,0.2) !important;display:flex !important;gap:12px !important;justify-content:flex-end !important;">
        <button class="mt-nav-btn" ${mockTestState.currentQuestionIndex === 0 ? 'disabled' : ''} onclick="window._mtPreviousQuestion()" style="padding:10px 20px !important;background:rgba(108,99,255,0.15) !important;border:1px solid rgba(108,99,255,0.3) !important;border-radius:6px !important;color:rgba(255,255,255,0.85) !important;font-size:13px !important;font-weight:600 !important;cursor:pointer !important;transition:all 0.2s !important;">← Back</button>
        <button class="mt-nav-btn" onclick="window._mtSkipQuestion()" style="padding:10px 20px !important;background:rgba(108,99,255,0.15) !important;border:1px solid rgba(108,99,255,0.3) !important;border-radius:6px !important;color:rgba(255,255,255,0.85) !important;font-size:13px !important;font-weight:600 !important;cursor:pointer !important;transition:all 0.2s !important;">
          ${mockTestState.currentQuestionIndex === totalQuestions - 1 ? 'Finish Test' : 'Skip →'}
        </button>
      </div>
    `;
